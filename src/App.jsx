...
const App = () => {
  ...
  const inputs = [
    ...
    },
    {
      ...
      errorMessage:
        "Password should be 8-20 characters with minimum 1 letter, 1 number and 1 special character",
      label: "Password",
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="formInput" required>
          ...
          >
            ...
            {extData.occupations
              ? extData.occupations.map((occ, key) => (
                <option key={key} value={occ}>
                  {occ}
                </option>
              ))
              : null}
